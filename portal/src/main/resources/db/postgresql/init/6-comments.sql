...
comment on column ems.cfg_apps.env_ids is '适用场景ID列表';
...
comment on column ems.cfg_envs.id is '非业务主键';
...
comment on column ems.se_role_app_envs.id is '非业务主键';
...
comment on column ems.usr_role_members.env_ids is '适用场景ID列表';
...
comment on column ems.usr_roles.env_ids is '适用场景ID列表';
