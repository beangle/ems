...
comment on column ems.cfg_apps.env_ids is 'envIds?';
...
comment on column ems.cfg_third_party_apps.redirect_uri is 'redirectUri?';
...
comment on column ems.oa_notice_attachments.embedded is 'embedded?';
comment on column ems.oa_notice_attachments.file_path is 'filePath?';
comment on column ems.oa_notice_attachments.file_size is 'fileSize?';
comment on column ems.oa_notice_attachments.id is '非业务主键:datetime';
comment on column ems.oa_notice_attachments.name is 'name?';
comment on column ems.oa_notice_attachments.notice_id is '公告ID';
...
comment on column ems.se_channels.channel_type_id is '端类型ID';
comment on column ems.se_channels.id is '非业务主键:auto_increment';
comment on column ems.se_channels.name is '名称';
...
comment on column ems.se_menus.channel_id is '菜单端ID';
...
comment on column ems.se_oauth_tokens.client_id is 'ThirdPartyApp?ID';
comment on column ems.se_oauth_tokens.expired_at is 'expiredAt?';
comment on column ems.se_oauth_tokens.id is '非业务主键:auto_increment';
comment on column ems.se_oauth_tokens.issued_at is 'issuedAt?';
comment on column ems.se_oauth_tokens.scope_ is 'scope?';
comment on column ems.se_oauth_tokens.token is 'token?';
comment on column ems.se_oauth_tokens.user_id is '用户ID';
...
comment on column ems.usr_env_profiles.properties is 'properties?';
...
comment on column ems.usr_role_members.env_ids is 'envIds?';
...
comment on column ems.usr_roles.env_ids is 'envIds?';
...
comment on table ems.cfg_channel_types is '端类型';
...
comment on table ems.oa_notice_attachments is 'NoticeAttachment?';
...
comment on table ems.se_channels is '菜单端';
...
comment on table ems.se_oauth_tokens is 'OAuthToken?';
comment on table ems.se_role_app_envs is 'RoleAppEnv?';
...
comment on table ems.usr_env_profiles is 'EnvProfile?';
