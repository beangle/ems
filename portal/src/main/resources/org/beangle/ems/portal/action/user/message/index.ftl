...
<div class="container-fluid">
    ...
    <section class="content">
      <div class="row">
        <div class="col-md-2">
          [@b.a href="!editNew" target="messageList" class="btn btn-primary w-100 mb-2"]发送新消息[/@]
            ...
            <div class="card-body">
              <ul class="nav nav-pills flex-column" id="msgboxList">
                ...
                [@b.a class="nav-link active" href="!search?message.status=1" target="messageList"]
                  ...
                  [#if (stats['1']!0)>0]
                  <span class="badge bg-primary float-end">${stats['1']!0}</span>
                  [/#if]
                [/@]
                </li>
                <li class="nav-item">
                   [@b.a class="nav-link" href="!search?message.status=2" target="messageList"]
                    ...
                    [#if (stats['2']!0)>0]
                    <span class="badge bg-primary float-end">${stats['2']!0}</span>
                    [/#if]
                   [/@]
                </li>
                ...
                <li class="nav-item">
                    ...
                    [#if (stats['3']!0)>0]
                    <span class="badge bg-primary float-end">${stats['3']!0}</span>
                    [/#if]
                    [/@]
                </li>
              </ul>
