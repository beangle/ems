...
[@b.grid items=themes var="theme"]
  ...
  [@b.row]
    ...
    [@b.col width="12%" property="primaryColor" title="超链接字体颜色"]
      <div style="background-color:${theme.primaryColor!}">&nbsp;</div>
    [/@]
    [@b.col width="12%" property="navbarBgColor" title="导航区背景"]
      <div style="background-color:${theme.navbarBgColor}">&nbsp;</div>
    [/@]
    [@b.col width="12%" property="searchBgColor" title="查询区背景"]
      <div style="background-color:${theme.searchBgColor}">&nbsp;</div>
    [/@]
    [@b.col width="12%" property="gridbarBgColor" title="表格工具栏背景"]
      <div style="background-color:${theme.gridbarBgColor}">&nbsp;</div>
    [/@]
    [@b.col width="12%" property="gridHeaderBgColor" title="表格表头背景"]
      <div style="background-color:${theme.gridHeaderBgColor}">&nbsp;</div>
    [/@]
    [@b.col width="12%" property="gridBorderColor" title="表格边框颜色"]
