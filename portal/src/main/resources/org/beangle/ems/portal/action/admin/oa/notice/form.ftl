...
[@b.form action=b.rest.save(notice) theme="list"]
  [@b.textfield name="notice.title" label="标题" value=notice.title! required="true" maxlength="100" style="width:400px;"/]
  ...
  [@b.checkboxes name="category.id" label="面向用户" values=notice.categories required="true" items=categories/]
