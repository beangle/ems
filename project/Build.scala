...
object EmsDepends {
  ...
  val beangle_bui_tag = "org.beangle.bui" % "beangle-bui-tag" % "0.8.6"
  val beangle_bui_bootstrap = "org.beangle.bui" % "beangle-bui-bootstrap" % "0.8.6"
  ...
  val beangle_ids = "org.beangle.ids" % "beangle-ids" % "0.4.20-SNAPSHOT"
