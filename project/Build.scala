...
object EmsDepends {
  ...
  val beangle_model = "org.beangle.data" % "beangle-model" % "5.10.1-SNAPSHOT"
  val beangle_cdi = "org.beangle.cdi" % "beangle-cdi" % "0.7.6-SNAPSHOT"
  val beangle_web = "org.beangle.web" % "beangle-web" % "0.6.7-SNAPSHOT"
  val beangle_cache = "org.beangle.cache" % "beangle-cache" % "0.1.16"
  val beangle_template = "org.beangle.template" % "beangle-template" % "0.1.29-SNAPSHOT"
  val beangle_webmvc = "org.beangle.webmvc" % "beangle-webmvc" % "0.11.1-SNAPSHOT"
  val beangle_bui_tag = "org.beangle.bui" % "beangle-bui-tag" % "0.0.10-SNAPSHOT"
  val beangle_bui_bootstrap = "org.beangle.bui" % "beangle-bui-bootstrap" % "0.0.10-SNAPSHOT"
  val beangle_serializer = "org.beangle.serializer" % "beangle-serializer" % "0.1.20"
  val beangle_security = "org.beangle.security" % "beangle-security" % "4.4.1"
  val beangle_ids = "org.beangle.ids" % "beangle-ids" % "0.4.1"
