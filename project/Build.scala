...
object EmsDepends {
  ...
  val beangle_ids = "org.beangle.ids" % "beangle-ids" % "0.4.9"
  ...
  val beangle_security = "org.beangle.security" % "beangle-security" % "4.4.9"
  ...
  val beangle_webmvc = "org.beangle.webmvc" % "beangle-webmvc" % "0.14.1"
