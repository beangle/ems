...
object EmsDepends {
  val beangle_bui_tag = "org.beangle.bui" % "beangle-bui-tag" % "0.1.2"
  ...
  val beangle_ids = "org.beangle.ids" % "beangle-ids" % "0.4.4"
  val beangle_model = "org.beangle.data" % "beangle-model" % "5.11.5"
  val beangle_jdbc = "org.beangle.jdbc" % "beangle-jdbc" % "1.1.5"
  val beangle_security = "org.beangle.security" % "beangle-security" % "4.4.4"
  ...
  val beangle_notify = "org.beangle.notify" % "beangle-notify" % "0.1.17"
