...
comment on column cfg.app_groups.en_title is '英文标题';
...
comment on column cfg.apps.en_title is '英文标题';
...
comment on column cfg.domains.en_title is '英文标题';
...
comment on column cfg.domains.sashub_base is 'SasHub的地址';
comment on column cfg.domains.sashub_profile is 'SasHub上注册的key';
...
comment on column cfg.portalets.id is '非业务主键:auto_increment';
comment on column cfg.portalets.name is '名称';
comment on column cfg.portalets.title is 'title?';
comment on column cfg.portalets.url is 'url?';
comment on column cfg.portalets.using_iframe is 'usingIframe?';
...
comment on column oa.messages.contents is 'contents?';
comment on column oa.messages.id is '非业务主键:datetime';
comment on column oa.messages.recipient_id is '用户ID';
comment on column oa.messages.sender_id is '用户ID';
comment on column oa.messages.sent_at is 'sentAt?';
comment on column oa.messages.status is 'status?';
comment on column oa.messages.title is 'title?';
...
comment on column oa.notices.issuer is 'issuer?';
...
comment on column oa.notifications.contents is 'contents?';
comment on column oa.notifications.id is '非业务主键:datetime';
comment on column oa.notifications.importance is 'importance?';
comment on column oa.notifications.recipient_id is '用户ID';
comment on column oa.notifications.sent_at is 'sentAt?';
comment on column oa.notifications.subject is 'subject?';
...
comment on column oa.todoes.contents is 'contents?';
comment on column oa.todoes.domain_id is '业务系统ID';
comment on column oa.todoes.id is '非业务主键:datetime';
comment on column oa.todoes.updated_at is '更新时间';
comment on column oa.todoes.user_id is '用户ID';
...
comment on table cfg.portalets is 'Portalet?';
...
comment on table oa.messages is 'Message?';
...
comment on table oa.notifications is 'Notification?';
comment on table oa.sensitive_words is '敏感词汇';
comment on table oa.todoes is 'Todo?';
