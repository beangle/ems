...
insert into cfg.orgs(id,code,name,short_name,www_url,logo_url) values(${schoolId},'1','组织名','简称','www.baidu.com','www.baidu.com');
insert into cfg.domains(id,org_id,name,title,hostname,logo_url) values(${domainId},${schoolId},'sys-name','系统名称','www.baidu.com','www.baidu.com');
...
insert into cfg.app_groups(id,name,title,indexno,domain_id) values(1,'platform','系统管理','9',{domainId});

insert into cfg.apps(id,name,secret,app_type_id,url,enabled,base,indexno,title,group_id,domain_id,nav_style)
...
insert into usr.roots(id,app_id,user_id,updated_at)
